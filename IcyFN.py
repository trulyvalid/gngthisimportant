...
'''
        ...
        while True:
            try:
                r = requests.get('https://github.com/trulyvalid/gngthisimportant/blob/main/version.txt')
                ver = r.text.strip()
                break
            except:
        ...
        if str(ver) == str(self.version):
            ...
            while True:
                try:
                    r = requests.get('https://github.com/trulyvalid/gngthisimportant/blob/main/main.py', timeout=10)
        ...
        system('cls')
        windll.kernel32.SetConsoleTitleW(
                f' | v{self.version} | Select a mode')
        print(self.t)
        print(f'''
...
''')
        ...
        if mode == "5":
            ...
            print(self.t)
            windll.kernel32.SetConsoleTitleW(
                f'IcyFN V{self.version} | Module: ComboEditor')
            print(f'''
...
''')
            ...
            windll.kernel32.SetConsoleTitleW(
                f'IcyFN | v{self.version} | Scraping Proxies | BoltProxy')
            ...
            while True:
                ...
                if len(urls) > 0:
                    ...
                    break
            windll.kernel32.SetConsoleTitleW(
                f'IcyFN | v{self.version} | Done Scraping | BoltProxy')
                ...
                while True:
                    try:
                        if Checker.mode.lower() == 'bolt':
                            self.cuitype = 'bolt'
                            print(Fore.MAGENTA)
                            print_slowly('Using IcyFN CUI', 0.05)
                            break
        ...
        print(f'{Fore.LIGHTCYAN_EX}[IcyFN] Starting Threads...\n')
        windll.kernel32.SetConsoleTitleW(
            f'IcyFN | v{self.version} | Getting ready!')
                                        ...
                                        try:
                                            ...
                                            if Checker.webhook.webhooky:
                                                payload = {
                                                        ...
                                                        "embeds": [
                                                            {
                                                            "author": {"name": "trultvalid", "url": "https://github.com/trulyvalid/gngthisimportant", "icon_url": "https://cdn-icons-png.flaticon.com/512/25/25231.png"},
                                                            "title": display_name,
                                                            "color": 15054874,
                                                            "fields": [
